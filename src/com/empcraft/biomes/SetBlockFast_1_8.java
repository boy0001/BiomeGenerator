...
public class SetBlockFast_1_8 {
    ...
    private static ChunkLoc lastLoc = null;
    ...
    public static void set(final World world, final int x, final int y, final int z, final int id, final byte data) {
        if (id == -1) {
    ...
    public static void update(final Collection<Chunk> chunks) {
        if (chunks.size() == 0) {
            return;
        }
