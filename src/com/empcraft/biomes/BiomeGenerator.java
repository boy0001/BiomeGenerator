...
public class BiomeGenerator {
    ...
    public BiomeGenerator(final Biome biome, final long seed) {
        this.biome = biome;
        this.seed = seed;
            ...
            for (int zv = selectionArray[1]; zv <= selectionArray[3]; zv += 16) {
                ...
                Bukkit.getScheduler().runTaskLater(plugin, new Runnable() {
                    ...
                    public void run() {
                        ...
                        long init_state = BiomeGenerator.this.state;
                        ...
                        for (int cx = 0; cx < 16; ++cx) {
                            for (int cz = 0; cz < 16; ++cz) {
                                ...
                                if ((wx >= selectionArray[0]) && (wz >= selectionArray[1]) && (wx <= selectionArray[2]) && (wz <= selectionArray[3])) {
                                    ...
                                    if (BiomeGenerator.this.biome == Biome.MESA) {
                                        Random r = new Random();
                                            ...
                                            if ((wy > 0) && (wy < worldHeight)) {
                                                ...
                                                if (id != 0) {
                                                    ...
                                                    if (id == 12) {
                                                        ...
                                                        BiomeGenerator.this.state = init_state + scy;
                                                        
                                                        long num = BiomeGenerator.nextLong();
